...
import { useSearchParams } from 'next/navigation'; // Use this to read query parameters

function Model() {
  const searchParams = useSearchParams(); // Get the query parameters from the URL
  const rooms = searchParams.get('rooms') || 'Not specified';
  const floors = searchParams.get('floors') || 'Not specified';
  const buildingType = searchParams.get('buildingType') || 'Not specified'; // Set default if not provided
            ...
            <a href="#" className="group relative block h-48 sm:h-60 lg:h-72">
              ...
              >
                ...
                >
                  ...
                  <h2 className="mt-4 text-lg font-medium sm:text-xl text-gray-800">
                    Model {index + 1}
                  </h2>
                </div>
                ...
                >
                  <h3 className="mt-4 text-lg font-medium sm:text-xl text-gray-800">
                    Model {index + 1}
                  </h3>
