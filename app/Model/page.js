    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8 bg-white">
      ...
      <div className="flex flex-wrap justify-center max-w-screen-lg">
        {Array.from({ length: 6 }).map((_, index) => (
          <div key={index} className="w-full sm:w-1/2 lg:w-1/3 p-8 mb-8">
            <a href="#" className="group relative block h-48 sm:h-60 lg:h-72">
              ...
              <div className="relative flex h-full transform items-end border-2 border-teal-600 bg-white transition-transform group-hover:-translate-x-2 group-hover:-translate-y-2">
                <div className="p-6 transition-opacity group-hover:absolute group-hover:opacity-0 sm:p-6 lg:p-8">
                  <svg
                ...
                <div className="absolute p-6 opacity-0 transition-opacity group-hover:relative group-hover:opacity-100 sm:p-6 lg:p-8">
                  <h3 className="mt-4 text-lg font-medium sm:text-xl text-gray-800"></h3>
                  <p className="mt-4 text-sm sm:text-base text-gray-600">Model</p>
